...
////// temporarily comment out full screen functionalities 
...
$("#chat_input_submit").click(function(){
  var toSend = $("#chat_input_text").val();
  $('#chat_mes_display').append('<br/> ME: '+ toSend);
  // TO DO: create the channel and use the channel to send messages, taken by servers, and handle the messages
  sendMessage({type: 'peerMsg', content: toSend});
  $("#chat_input_text").val('');
});
